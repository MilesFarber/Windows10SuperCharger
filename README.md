...
* Remote Desktop must be enabled and you must have logged in with standard password at least once, this is required to fix SAMBA. This won't be automated for security reasons.
