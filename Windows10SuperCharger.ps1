...
Add-AppxPackage -Path https://github.com/MilesFarber/WingetBackup/raw/trainer/wingetsource.msix
...
Write-Output "Disabling page encryption to improve NVME longevity."
